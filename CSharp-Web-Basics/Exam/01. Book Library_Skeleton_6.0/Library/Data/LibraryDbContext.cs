...
namespace Library.Data
{
    public class LibraryDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<ApplicationUser>().Property(x => x.UserName).HasMaxLength(20).IsRequired();

            builder.Entity<ApplicationUser>().Property(x => x.Email).HasMaxLength(60).IsRequired();

            builder.Entity<ApplicationUser>().Property(x => x.Email).HasMaxLength(60).IsRequired();

            builder.Entity<ApplicationUser>().Property(p => p.PasswordHash).HasColumnName("Password").IsRequired();
